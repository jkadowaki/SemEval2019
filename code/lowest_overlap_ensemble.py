...
def main(verbose=False):
    ...
    # Generated Files
    plot_f1_ol_pred = "f1_ol_pred.pdf"
    plot_f1_ol_pred = "f1_ol_pred.pdf"
    plot_f1_ol_pred = "f1_ol_pred.pdf"
    plot_f1_ol_prob = "f1_ol_prob.pdf"
    plot_f1_ol_prob = "f1_ol_prob.pdf"
    plot_f1_ol_prob = "f1_ol_prob.pdf"

    plot_deltaf1_ol_pred = "deltaf1_ol_pred.pdf"
    plot_deltaf1_ol_pred = "deltaf1_ol_pred.pdf"
    plot_deltaf1_ol_pred = "deltaf1_ol_pred.pdf"
    plot_deltaf1_ol_prob = "deltaf1_ol_prob.pdf"
    plot_deltaf1_ol_prob = "deltaf1_ol_prob.pdf"
    plot_deltaf1_ol_prob = "deltaf1_ol_prob.pdf"
    ...
    for f in folds:
        ...
        plt.imshow(overlap_pred, interpolation='nearest')
        plt.colorbar()
